...
public class DnsClient {
    ...
    private String name;
    private int port = 53;
    private DnsResponseListener listener;
    ...
    public DnsClient(String address, int port, String name, DnsResponseListener listener) {
    ...
    private void pollRequest(int retryNumber) {
        ...
        try {
            ...
            if (listener != null) {
                listener.onResponse(endTime - startTime);
            }
    ...
    public interface DnsResponseListener {
